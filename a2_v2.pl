			...
			if($flag == 0)
			{
				...
				foreach my $line (@atoms)
				{
					...
					if($i != 0)
					{
						...
						#angles
						my $psi = acos($unitVectorX);
						my $theta = acos($unitVectorY);
						my $phi = acos($unitVectorZ);
						...
						#transformation
						my $transformedCA2_x = $R11*$newVectorX + $R12*$newVectorY + $R13*$newVectorZ;
						my $transformedCA2_y = $R21*$newVectorX + $R22*$newVectorY + $R23*$newVectorZ;
						my $transformedCA2_z = $R31*$newVectorX + $R32*$newVectorY + $R33*$newVectorZ;
						########################
						...
						$line       =~ substr($line, 27, 11, $transCoordinatesX);  # columns 31-38
						$line       =~ substr($line, 39, 7, $transCoordinatesY);  # columns 39-46
						$line       =~ substr($line, 47, 7, $transCoordinatesZ);  # columns 47-54
